...
class _P02PracticeCatalogPageState extends State<P02PracticeCatalogPage> {
  ...
  List<Widget> _buildChapterItems() {
    final chapters = [
      {'name': '第一章：教育基础', 'progress': '42/84', 'fillWidth': 154.0, 'fillColor': const Color(0xFFEAF3FF), 'textColor': AppColors.textPrimary, 'progressColor': AppColors.textSecondary, 'isCompleted': false},
      {'name': '第二章：班级管理', 'progress': '24/72', 'fillWidth': 96.0, 'fillColor': const Color(0xFFEAF3FF), 'textColor': AppColors.textPrimary, 'progressColor': AppColors.textSecondary, 'isCompleted': false},
      {'name': '第三章：学生发展', 'progress': '60/96', 'fillWidth': 188.0, 'fillColor': const Color(0xFFEAF3FF), 'textColor': AppColors.textPrimary, 'progressColor': AppColors.textSecondary, 'isCompleted': false},
      {'name': '第四章：打分考评', 'progress': '80/80', 'fillWidth': 0.0, 'fillColor': const Color(0xFFECFDF5), 'textColor': const Color(0xFF064E3B), 'progressColor': const Color(0xFF047857), 'isCompleted': true},
    ];
